          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body pad table-responsive">
              <div class="row">
                ...
                <div class="col-md-6">
                  <form action="<?=site_url('buku/edit_data/'.$buku->id)?>" method="post">
                    <div class="form-group">
                      <label for="id">ID Buku</label>
                      <input type="text" name="id" id="id" value="<?=$buku->id?>" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="kategori" id="kategori" class="form-control select2" style="width: 100%;" required>
                        ...
                        <?php foreach($kategori as $k) { ?>
                          <option value="<?=$k->id?>" <?=$k->id == $buku->id_kategori ? "selected" : null?>><?=$k->nama?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <select name="koleksi" id="koleksi" class="form-control select2" style="width: 100%;" required>
                        ...
                        <?php foreach($koleksi as $k) { ?>
                          <option value="<?=$k->id?>" <?=$k->id == $buku->id_koleksi ? "selected" : null?>><?=$k->nama?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
