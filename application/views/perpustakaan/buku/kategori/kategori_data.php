          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              <div class="float-sm-right">
                <a href="<?=site_url('kategori/add_data')?>" class="btn btn-primary">
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center" width="150px">
                        <a href="<?=site_url('kategori/edit_data/' . $d->id)?>" class="btn btn-warning btn-xs" style="color: white;">
                          <b><i class="fas fa-edit"></i> Edit</b>
                        </a>
                        <a href="<?=site_url('kategori/delete_data/' . $d->id)?>" class="btn btn-danger btn-xs">
