        ...
        <div class="col-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><b>Edit Peminjaman</b></h3>
            ...
            <div class="card-body pad table-responsive">
              <div class="row">
                ...
                <div class="col-md-6">
                  <form action="<?=site_url('peminjaman/edit_data/' . $peminjaman->id_pinjam)?>" method="post">
                    <div class="form-group">
                      <label for="id">ID Peminjaman *</label>
                      <input type="text" name="id" id="id" value="<?=$peminjaman->id_pinjam?>" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                      <label for="tgl_pinjam">Tgl Peminjaman *</label>
                      <div class="input-group date" id="tglpinjam" data-target-input="nearest">
                        <input type="text" name="tgl_pinjam" value="<?=$peminjaman->tgl_pinjam?>" class="form-control datetimepicker-input" data-target="#tglpinjam" required/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="tglkembali" data-target-input="nearest">
                        <input type="text" name="tgl_kembali" value="<?=$peminjaman->tgl_kembali?>" class="form-control datetimepicker-input" data-target="#tglkembali" required/>
                    ...
                    <div class="form-group">
                      ...
                      <select name="nama" id="nama" class="form-control select2" style="width: 100%;" required>
                        ...
                        <?php foreach($anggota as $a) { ?>
                          <option value="<?=$a->id_anggota?>" <?=$a->id_anggota == $peminjaman->id_anggota ? "selected" : null?>><?=$a->nama_anggota?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <select name="judul" id="judul" class="form-control select2" style="width: 100%;" required>
                        ...
                        <?php foreach($buku as $b) { ?>
                          <option value="<?=$b->id?>" <?=$b->id == $peminjaman->kd_buku ? "selected" : null?>><?=$b->judul?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
